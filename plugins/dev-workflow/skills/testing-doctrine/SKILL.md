...
Stack-agnostic. The *patterns* — `bloc_test`, XCTest, whatever the stack uses — live in that
stack's testing skill. This is the part that does not change when the language does.
