...
Scaffold a new SwiftUI app using this boilerplate. This is a human-readable command template for maintainers.
...
4. Add assets and string catalog per `PLAN.md`.
